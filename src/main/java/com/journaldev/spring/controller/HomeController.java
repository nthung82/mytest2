...
public class HomeController {
	...
	public String home(Locale locale, Model model, HttpServletRequest r) {
		logger.info("Welcomed home! The client lsdfsdfsocale is {1}.", r.getParameter("hungnt"));
		Date date = new Date();
	...
	public String home1(Locale locale, Model model,HttpServletRequest r) {
		logger.info("Welcome home! The client locale is {}.", r.getParameter("hungnt"));
		Date date = new Date();
		DateFormat dateFormat = DateFormat.getDateTimeInstance(DateFormat.LONG, DateFormat.LONG, locale);
